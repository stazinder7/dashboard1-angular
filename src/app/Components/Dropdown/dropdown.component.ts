...
dropdown2 = [
  {
    path: 'https://techcommunity.microsoft.com/t5/image/serverpage/image-id/172206i70472167E79B9D0F/image-size/large?v=v2&px=999',
    text: 'Html',
  },
  {
    path: 'https://techcommunity.microsoft.com/t5/image/serverpage/image-id/172206i70472167E79B9D0F/image-size/large?v=v2&px=999',
...
ngAfterViewInit() {
  document.addEventListener('keydown', function (e) {
    if (e.keyCode == 38) {
      ...
      jQuery('.select_dropdown li').removeClass('selected');
...
dropDownDirection() {
  setTimeout(() => {
    ...
    let dropDownTop = jQuery('#searchfield1').offset().top;
